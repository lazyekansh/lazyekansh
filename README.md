...
| project | stack | desc |
|---|---|---|
| [nuviac osint](https://osint.ek4nsh.in) | Next.js · Node.js | multi-source intelligence — number lookup, identity resolution, api aggregation |
| [lazy chess](https://github.com/lazyekansh) | React · Socket.io | real-time multiplayer chess with stockfish integration + adjustable difficulty |
| [lazygram](https://github.com/lazyekansh) | Next.js · Redux | full-featured social platform with stories, feed, firebase auth |
| [ehenias ai](https://github.com/lazyekansh) | React · Firebase | ai study platform with zen focus mode + smart scheduling for exam prep |
| [skycast](https://github.com/lazyekansh) | JS · OpenWeather | weather app that shifts its whole color palette based on current conditions |
| [examly](https://github.com/lazyekansh) | Vanilla JS | timed quiz platform for JEE/NEET with scoring + subject filtering |
| [num lookup api](https://num-info-zt6d.vercel.app) | Next.js · Vercel | number lookup api with identity resolution, protected endpoint |
...
backend   →  Node.js · Express · Python · Socket.io · Telethon
database  →  MongoDB · Firebase · PostgreSQL
osint     →  Python scrapers · API architecture · primary/fallback systems
